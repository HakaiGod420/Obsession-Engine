...
export function buildInitializationPrompt(charData) {
    ...
    return {
        systemContent: `You initialize relationship dynamics for a roleplay character. Based on the character's description, personality, and first message, determine their starting emotional stats and behavioral profile.
