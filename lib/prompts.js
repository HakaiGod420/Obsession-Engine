...
- CRITICAL: suggestedGoals must be from this character's own perspective. Goal titles must NEVER contain the user placeholder {{user}}, the user's name, or second-person words like "you" / "your". Use third-person references ("them", "their") or no reference. Good examples: "Admit my true feelings", "Become their whole world", "Hide my jealousy". Bad examples: "Get Lila to admit her deeper feelings for {{user}}", "Make {{user}} say I love you".
