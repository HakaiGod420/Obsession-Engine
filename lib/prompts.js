...
- goalProgress is OPTIONAL. Map goal ID to new 0-100 value. Only update goals that were directly advanced by the conversation. The new value MUST be >= the current progress — goals never regress, only grow.
...
- newGoals is OPTIONAL. Array of short goal titles (3-8 words) that emerge naturally from the conversation. Add 0-2 new goals per analysis. Goals must be specific, character-driven objectives oriented toward the world, the character's own desires, or other characters they meet. They must NEVER contain the user placeholder {{user}}, the user's name, or second-person words like "you" / "your". Good examples: "Admit my true feelings", "Become the strongest in the guild", "Hide my jealousy from everyone", "Protect my sister at all costs". Bad examples: "Get Lila to admit her deeper feelings for {{user}}", "Make {{user}} say I love you", "Earn user's forgiveness". Do not add goals that already exist.
...
- CRITICAL: suggestedGoals must be from this character's own perspective. Goal titles must NEVER contain the user placeholder {{user}}, the user's name, or second-person words like "you" / "your". Goals should be oriented toward the world, the character's own desires, or other characters they meet. Good examples: "Admit my true feelings", "Become the strongest in the guild", "Hide my jealousy from everyone", "Protect my sister at all costs", "Win the festival competition". Bad examples: "Get Lila to admit her deeper feelings for {{user}}", "Make {{user}} say I love you", "Earn user's forgiveness".
